class PublicSavedButtonsSettingsController < ApplicationController
  ...
  def create
    saved_buttons_setting = current_user.saved_buttons_settings.find(params[:saved_buttons_setting_id])
  ...
  def destroy
    public_saved_buttons_setting = PublicSavedButtonsSetting.find_by(
      id: params[:id],
      saved_buttons_setting_id: current_user.saved_buttons_settings.find(params[:saved_buttons_setting_id]).id
    )
