...
class GenerateSplatoon2SketchMacrosService
  # 偶数. 右へ移動する
  MACRO_POINT = [:pressing_a_for_0_05sec, :pressing_right_for_0_05sec]
  MACRO_NOT_POINT = [:wait_for_0_05sec, :pressing_right_for_0_05sec]

  # 奇数. 左へ移動する
  MACRO_REVERSE_POINT = [:pressing_a_for_0_05sec, :pressing_left_for_0_05sec]
  MACRO_REVERSE_NOT_POINT = [:wait_for_0_05sec, :pressing_left_for_0_05sec]

  MACRO_NEXT_LINE = [:pressing_down_for_0_05sec]
